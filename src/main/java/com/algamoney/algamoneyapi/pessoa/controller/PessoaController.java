...
public class PessoaController {
	...
	public Page<PessoaVO> listarPessoas(@RequestParam(name = "nome", required = false) String nome, Pageable pageable) {
		return pessoaService.listarPessoas(nome, pageable);
	}
